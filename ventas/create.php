                            ...
                            <div class="table-responsive mt-4">
                                <table class="table table-bordered table-sm table-hover table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th class="tbl_prods">Codigo TrucksRepair</th>
                                    ...
                                    foreach ($carrito_datos as $carrito_dato) {
                                        ...
                                        <tr>
                                            ...
                                            <td><center>
                                                    <?php echo $carrito_dato['id']; ?>
                                                </center>
                                            </td>
                                            <td>
                                                <center>
                                                    <?php echo $carrito_dato['nombre_producto']; ?></td>
                                                </center>
                                            <td>
                                                <center>
                                ...
                                <td>
                                    ...
                                    <script>
                                        $('#btn_seleccionar<?php echo $id_producto;?>').click(function () {
                                            ...
                                            var id = "<?php echo $productos_dato['id'] ?>";
                                            $('#id').val(id);
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <label>Codigo TrucksRepair</label>
